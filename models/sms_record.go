...
type (
	SmsRecord struct {
		...
		Remark     *string `json:"remark,omitempty"        gorm:"column:remark;type:varchar(30)"`
...
func (this *SmsRecord) ParseAdd(tempId *int64, Phone *string, SuccFlag, PlayTp, ReTry *int, Author *string, paramStr string, remark *string) *SmsRecord {
	c := &SmsRecord{
		TempId:     tempId,
		Phone:      Phone,
		SuccFlag:   SuccFlag,
